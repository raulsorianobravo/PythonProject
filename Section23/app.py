...
e2=Label(window,text="gr")
e2.grid(row=1,column=0) # The Label is placed in position 0, 0 in the window
t1=Text(window,height=1,width=20)
t1.grid(row=2,column=0)
 
e3=Label(window,text="pounds")
e3.grid(row=1,column=1) # The Label is placed in position 0, 0 in the window
t2=Text(window,height=1,width=20)
t2.grid(row=2,column=1)

e4=Label(window,text="ounces")
e4.grid(row=1,column=2) # The Label is placed in position 0, 0 in the window 
